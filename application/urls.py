...
urlpatterns = [
    ...
    # User details and activity update URLs
    path(
        "update_brushtime/",
        views.update_total_brush_time.as_view(),
        name="update_brush_time",
    ),
    ...
    path(
        ...
        views.UpdateLevelMaxXP.as_view(),
        name="update_level_max_xp",
    ),
